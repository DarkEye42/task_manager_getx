...
class _AddTaskScreenState extends State<AddTaskScreen> {
                            ...
                            return ElevatedButton(
                              onPressed: () {
                                if (_formKey.currentState!.validate() &&
                                  ...
                                  addTask(userViewModel, taskViewModel);
                                }
                              },
  ...
  void addTask(UserViewModel userViewModel, TaskViewModel taskViewModel) async {
    bool status = await taskViewModel.createTask(
        userViewModel.token,
