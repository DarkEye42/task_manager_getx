...
class UpdateProfileScreenForm extends StatelessWidget {
  ...
  final void Function(UserViewModel viewModel) onPressed;
        ...
        children: [
          ...
          Obx(() {
            return AppTextField(
              ...
              isObscureText: userViewModel.isPasswordObscured,
              suffixIcon: InkWell(
                splashColor: Colors.transparent,
                onTap: () {
                  userViewModel.setIsPasswordObscured =
                  !userViewModel.isPasswordObscured;
                },
                child: (userViewModel.isPasswordObscured)
          ...
          SizedBox(
            ...
            child: Obx(() {
              return ElevatedButton(
                onPressed: () => onPressed(userViewModel),
